...
{
    /// <summary>
    /// Can be used for itself or to navigate to a blank page inside the Frame.
    /// </summary>
    public sealed partial class MainPage : Page
    {
        ...
        private void Element_MediaEnded(object sender, RoutedEventArgs e)
        {
            ...
            //TODO: Realize automatic playback of the next song
        }
        ...
        private int GetId()
        {
            ...
            using (var statement = App.conn.Prepare(
                "SELECT Id, Name, Singer FROM MusicLib WHERE Id LIKE ? OR Name LIKE ? OR Singer LIKE ? "))
            {
        ...
        //RnD
        private void SearchBox_QuerySubmitted(AutoSuggestBox sender, AutoSuggestBoxTextChangedEventArgs args)
        {
            ObservableCollection<Song> Suggetion = new ObservableCollection<Song>();
